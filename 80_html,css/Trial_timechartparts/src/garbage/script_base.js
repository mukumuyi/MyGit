...
(function () {
    d3.timeline = function() {
      ...
      var appendLabel = function (gParent, yAxisMapping, index, hasLabel, datum,d,i) {
        var fullItemHeight    = itemHeight + itemMargin;
        // var rowsDown          = margin.top + (fullItemHeight/2) + fullItemHeight * (yAxisMapping[index] || 1);
        var rowsDown          = margin.top + (fullItemHeight/2) + itemHeight * datum.times[i].lane + itemMargin * datum.times[i].group ;
        gParent.append("text")
      ...
      function timeline (gParent) {
        ...
        g.each(function(d, i) {
          ...
          d.forEach( function(datum, index){
              ...
              .on("mouseover", function(d,i) {
                ...
                tooltip
                  ...
                  .html("name : " + datum.times[i].name
                   ...
                   + "<br>axis : " + yAxisMapping[index]
                   + "<br>description : " + maxlane    
                   + "<br>description2 : " + tempname                
                    );
              })
            ...
            if (hasLabel) { appendLabel(gParent, yAxisMapping, index, hasLabel, datum,d,i); }
            ...
            function getStackPosition(d, i) {
              if (stacked) {
                return margin.top + itemHeight * datum.times[i].lane + itemMargin * datum.times[i].group; // Add By muku
            ...
            function getStackTextPosition(d, i) {
              if (stacked) {
                return margin.top + itemHeight * datum.times[i].lane + itemMargin * datum.times[i].group + itemHeight * 0.75; // Add By muku
      ...
      console.log(belowLastItem)
      console.log(timeAxisYPosition)
